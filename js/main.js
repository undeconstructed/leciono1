...
const translations = {
  ...
  "es": {
    ...
    "06": "Algunas veces se quiere decir quíen hace la acción del verbo (el sujeto). Es muy fácil. Coje la raíz y transformala en sustantivo añadiendo el final <em>-o</em>.",
    "e02": "Un gato corría",
    ...
    "e10": "Ese gato cazaría un perro, si lo encontrara.",
    ...
    "sxi": "Alguien fenemino del que se habla: ella",
    ...
    "18": "Bien, ahora viene una parte difíl. ¿Estás preparado? A veces hay que unir frases de una manera especial en la que uno coge una idea de una frase y la introduce en otra. Para eso usamos la palabra <em>kiu</em>, que es como <em>tiu</em>, pero especial para citar la idea en otra frase:",
    ...
    "tabelti": "tiu- ese",
    "tabelki": "kiu- cuál",
    "tabeli": "iu- alguien, alguno",
    "tabelneni": "neniu- ninguno, nadie",
    "tabelcxi": "ĉiu- todos",
  ...
  "pt": {
    ...
    "01": "(Isto não é um curso de Esperanto, mas irá te dar uma ideia sobre a língua, e você provavelmente poderá aprender a maioria daquilo que é necessário, e também através de um pouco de leitura.)",
    "02": "Esperanto consiste em um cojunto de palavras-raízes, e um sistema para organizá-lo, para que se possa usá-lo para criar algo maior. Comecemos!",
    ...
    "e01": "Chove.",
    "05": "Eis uma frase. Se constrói frases ao redor de verbos - esse verbo contem a razão para fazer uma frase, e perceba quem diz algo quando algo acontece. Existe cinco finais:",
    ...
    "06": "Às vezes se quer dizer quem o que faz o verbo. Isto é muito fácil - Tome a raíz de algo e a transforme em um substantivo através do final <em>-o</em>.",
    "e02": "(O) gato correu.",
    "07": "Quando se quiser um outro conceito para um substantivo, tome a raíz de um substantivo e adicione <em>-a</em> para torná-lo adjetivo:",
    "e03": "(Um) Gato azul dormirá.",
    "08": "Talvez haja um outro conceito que, de alguma forma, se refere a dita ação. Talvez haja um local no qual ela ocorre. Para adicionar um outro substantivo, pode-se adicioná-lo por uma preposição para dizer como ele se refere a ação.",
    "e04": "(O) Gato azul se senta em frente a televisão (ilo-por-televidi).",
    ...
    "11": "Mas não faça isso muito frequentemente. Use apenas quando for usada para facilicar a compreenção.",
    "12": "Há apenas mais uma forma de verbo para se aprender: adverbos. Eu não sei exatamente o que é um adverbo, porém ele termina em <em>-e</em> e o usamos para descrever qualquer coisas que que não é substantivo. Eles são muito flexíveis (talvez perigosos!), no entanto, comece por metê-los antes da palavra a qual ele descreve e você logo comprenderá a ideia.",
    "e07": "O gato subitamente húmido (contrário de seco(a)) rapidamente (corre).",
    "13": "Por vezes, deve-se ser dizer mais precisamennte do que apenas \"gato\" - Deve-se dizer QUAL gato. A forma mais fácil é usar <em>o, a</em>, que basicamente significa \"Você sabe qual.\"",
    ...
    "15": "Quando se quer relacionar algumas frases, precisa-se de palavras para isso. Sempre se terá uma frase principal, como a anterior, mas orações relacionadas precisam de introdução. Exemplos:",
    "e10": "Este gato caçaria cachorros, caso ele os encontrasse.",
    "e11": "Este gato detesta cachorros, pois ele são barulhentos.",
    "16": "Enquanto quisermos, cada um dos pronomes:",
    ...
    "18": "Certo, agora vem a parte difícil. Você está pronto (a)? Por vezes se quer ligar frases através de uma forma especial, Por vezes se quer ligar frases através de uma forma especial, onde se toma ideias de uma frases e, de alguma forma, coloca-a em uma outra. Para isso, se usa a palavra <em>que, o qual</em>, que é como <em>este (a)</em>, porém é especialmente para citar uma ideia em uma outra oração:",
    "e12": "o gato, que caça cachorros, está feliz.",
    "19": "Hm, está suficientemente claro, que a \"que, o (a) qual\" se trata de gato? Sim, provavelmente, porém pode-se ser mais claro:",
    "e13": "o gato, cujo gato está grande, está dormente (ema-al-dormo).",
    ...
    "21": "Na verdade, há algumas facilitadores que podemos usar para isso:",
    "e15": "Estou feliz quando estou contigo.",
    "22": "Falaremos sobre todas estas palavras depois, mas por ora apenas uma mais: Às vezes, quer se simplesmente falar de .. algo. Não está claro de que coisa se trata, simplesmente se trata de algo. Nós experimentaremos isto:",
    "e16": "O que é isto? Isto é (um) gato.",
    "23": "Oh sim, Inclusive estas <em>ki-</em> palavras são boas para se usar como perguntas. Pense que signficam \"Coloque as coisas apropriadas aqui, eu peço\". Também existe recursos simples de se por uma questão sim/não:",
    "e17": "Você entende? sim … e não.",
    "24": "Certo. Resta apenas mais um assunto para se discutir. Começaremos facilmente e, depois, enlouqueceremos com ele. Quando se quer prescrever algo duas vezes, por espécie e por nome, coloque-os simplesmente juntos:",
    "e18": "Meu amigo Tomaso está alí/lá.",
    ...
    "28": "Mas lembre-se! Quanto mais palavras jogamos fora, maior o risque que tudo exploda!",
    "29": "Enquanto falamos de jogar palavras fora, há uma espécie de verbo, que de fato não é verbo. Quando dita palavra termina em <em>-i</em>, ela é uma espécie de ideia geral de verbo. O acontecimento não ocorre, ele apenas existe de alguma forma e informa que uma frase completa existe, de forma não dita. Mas tente imaginar se alguém poderia interpretar errado.",
    "e22": "O gato quer dormir.",
    "30": "E finalmente eis alguns tópicos que não quero explicar agora. Eles certamente seriam um pouco confusos, e geralmente se tratam de raízes bem úteis <em>ig</em> e <em>iĝ</em>.",
    ...
    "32": "Oh, espere, eu prometi falar sobre palavras ki- e ti- e neni-, porém não o fiz. De fato, inclusive nem mencionei neni- até o momento. Então, eis o começo de algumas palavras, simplesmente os ligue:",
    "tabelti": "tiu",
    "tabelki": "kiu",
    "tabeli": "iu",
    "tabelneni": "neniu",
    ...
    "tabela": "speco (também substantivo)",
