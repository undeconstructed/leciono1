...
const translations = {
  ...
  "th": {
    ...
    "01": "โอเค, ไม่มีทางเรียนรู้ภาษาใด ๆ ได้ภายใน 17 นาทีหรอก แต่สำหรับเอสเปรันโต คุณสามารถเข้าใจแนวคิดโดยรวมได้อย่างรวดเร็ว และเนื่องจากเอสเปรันโตมีความเป็นระบบอย่างมาก คุณจึงต้องเรียนรู้สิ่งต่าง ๆ เพียงครั้งเดียว",
    "02": "เอสเปรันโตเป็นภาษาที่เป็นกลางและเป็นสากล ถูกสร้างขึ้นเพื่อทุกคน แต่ในขณะเดียวกัน เอสเปรันโตก็เป็นชุดของรากศัพท์ และระบบสำหรับจัดเรียงคำเหล่านั้นเพื่อให้สามารถใช้สร้างสิ่งที่ใหญ่ขึ้นได้ – หากคุณเข้าใจระบบนี้ คุณสามารถพูดอะไรก็ได้ มาเริ่มกันเลย",
    "03": "มองออกไปนอกหน้าต่าง อาจจะกำลังมีฝนตก รากศัพท์ของคำนี้คือ <em>pluv-</em>",
    "04": "ฝนเป็นเหตุผลให้เราพูดถึงมัน หากต้องการบอกว่าฝนกำลังตก ให้นำรากศัพท์ \"pluv-\" และทำให้เป็นคำกริยา โดยเติมคำลงท้ายที่แสดงว่า \"เกิดขึ้นตอนนี้\" คือ <em>-as</em>",
    "e01": "ฝนกำลังตก",
    ...
    "06": "บางครั้ง เราต้องการบอกว่าใครหรืออะไรเป็นผู้กระทำกริยา วิธีทำสิ่งนี้ง่ายมาก – นำรากคำของสิ่งนั้นมา และทำให้เป็นคำนามโดยเติมคำลงท้าย <em>-o</em>",
    "e02": "แมววิ่งแล้ว",
    "07": "หากต้องการอธิบายคุณลักษณะของคำนาม ให้นำรากศัพท์มา และเติม <em>-a</em> เพื่อทำให้เป็นคำคุณศัพท์:",
    "e03": "แมวสีน้ำเงินจะนอน",
    "08": "บางทีอาจมีการอธิบายอื่นที่เกี่ยวข้องกับการกระทำนี้ เช่น สถานที่ที่มันเกิดขึ้น หากต้องการเพิ่มคำนามอื่นเข้าไป สามารถใช้คำบุพบทเพื่อแสดงว่ามันเกี่ยวข้องกับการกระทำอย่างไร",
    "e04": "แมวสีน้ำเงินนั่งอยู่หน้าทีวี (อุปกรณ์สำหรับดูภาพทางไกล=โทรทัศน์)",
    "09": "บางครั้ง ไม่มีคำบุพบทที่ชัดเจน หรือคุณไม่ต้องการใช้มัน ในกรณีนั้น คุณสามารถทำเครื่องหมายคำนาม (และคำคุณศัพท์ของมัน) ด้วยคำลงท้าย <em>-n</em> เพื่อแสดงว่า \"คุณรู้ว่าหมายถึงอะไร\"",
    "e05": "แมวตัวน้อยไม่ชอบฝนตกหนัก",
    "10": "นอกจากนี้ เนื่องจากทุกอย่างมีเครื่องหมายกำกับไว้อย่างชัดเจน เราสามารถสลับตำแหน่งคำได้บ้าง:",
    "e06": "แมวเกลียด (ตรงข้ามกับรัก ami) ฝนที่หนาวเย็น (ตรงข้ามกับร้อน varma)",
    "11": "แต่ไม่ควรสลับมากเกินไป ใช้เมื่อมันช่วยให้เข้าใจประโยคได้ง่ายขึ้น",
    "12": "มีคำอีกประเภทหนึ่งที่ต้องเรียนรู้: คำวิเศษณ์ ฉันไม่รู้ว่าคำกริยาวิเศษณ์คืออะไร แต่คำเหล่านี้ลงท้ายด้วย <em>-e</em> และใช้เพื่ออธิบายสิ่งที่ไม่ใช่คำนาม พวกมันมีความยืดหยุ่นมาก (บางทีอาจจะทำให้สับสน!) แต่ให้เริ่มโดยวางมันไว้ข้างหน้าคำที่มันอธิบาย แล้วคุณจะเข้าใจวิธีการได้ไม่ยาก:",
    "e07": "แมวที่เปียก (ตรงข้ามกับแห้ง seka) อย่างกะทันหันวิ่งเข้าไปอย่างรวดเร็ว",
    "13": "บางครั้งเราต้องการเจาะจงมากกว่าแค่ \"แมว\" หมายถึงแมวทั่ว ๆ ไป – เราต้องการบอกว่าเป็นแมวตัวไหน วิธีที่ง่ายที่สุดคือใช้ <em>la</em> ซึ่งโดยพื้นฐานหมายถึง \"คุณรู้ว่าหมายถึงตัวที่เรากำลังพูดถึง\"",
    "e08": "แมวกินอาหาร (สิ่งสำหรับกิน)",
    "14": "หรือบางทีเราอาจต้องการบอกว่า \"ตัวนั้นที่เรากำลังพูดถึงอยู่\":",
    ...
    "16": "ตอนนี้เรามาพูดถึงคำสรรพนามทั้งหมดกันเถอะ:",
    "mi": "ผม, ดิฉัน",
    "ni": "พวกเรา",
    "vi": "คุณ",
    "gxi": "มัน",
    ...
    "18": "โอเค ตอนนี้มาถึงส่วนที่ยากแล้ว คุณพร้อมไหม? บางครั้งเราต้องการเชื่อมโยงประโยคเข้าด้วยกันในลักษณะพิเศษ โดยการนำแนวคิดจากประโยคหนึ่งไปใส่ในอีกประโยคหนึ่ง สำหรับสิ่งนี้ เราใช้คำว่า <em>kiu</em> ซึ่งเหมือนกับ <em>tiu</em> แต่ใช้เฉพาะเมื่อต้องเชื่อมประโยค (หรือขยายความจะประโยคหลัก):",
    "e12": "แมวที่ไล่ล่าหมา มีความสุข",
    "19": "อืม มันชัดเจนพอไหมว่า 'kiu' หมายถึงแมว? ก็น่าจะใช่นะ แต่เราสามารถทำให้ชัดเจนขึ้นได้:",
    "e13": "แมว ที่เป็นแมวตัวใหญ่ กำลังง่วงนอน",
    "20": "ที่จริงแล้ว เราสามารถการอธิบายใดก็ได้จากประโยคหลัก และใส่เข้าไปในประโยครองได้ เราแค่ต้องบอกว่ามันเป็นเรื่องเกี่ยวกับอะไร:",
    "e14": "ฉันทำสิ่งนั้นตอนแปดโมง ซึ่งในตอนนั้นฉันหัวเราะ",
    "21": "ที่จริง ในกรณีนี้ เราสามารถใช้คำอื่นที่ง่ายกว่า:",
    "e15": "ฉันรู้สึกพอใจ เมื่อฉันอยู่กับคุณ",
    "22": "เราจะพูดถึงคำประเภทนี้ทั้งหมดในภายหลัง แต่ตอนนี้ ขอยกมาสักอีกคำหนึ่งก่อน: บางครั้งเราต้องการพูดถึง...บางสิ่ง แต่ไม่ชัดเจนว่ามันคืออะไร เป็นเพียงแค่บางสิ่งเท่านั้น มาลองดูตัวอย่าง:",
    "e16": "สิ่งนั้นคืออะไร? มันคือแมว",
    "23": "Hโอ้ ใช่แล้ว คำที่ขึ้นต้นด้วย <em>ki-</em> พวกนี้ก็ดีสำหรับการตั้งคำถาม ลองคิดว่ามันหมายถึง 'ใส่สิ่งที่เหมาะสมลงตรงนี้ให้หน่อย' นอกจากนี้ ยังมีวิธีง่าย ๆ ในการตั้งคำถามแบบใช่/ไม่ใช่อีก:",
    "e17": "คุณเข้าใจไหม? ใช่...และไม่",
    "24": "ดีมาก เหลืออีกเพียงเรื่องเดียวที่ต้องพูดถึง เราจะเริ่มจากง่าย ๆ แล้วค่อยซับซ้อนขึ้นไป หากต้องการอธิบายสิ่งหนึ่งด้วยสองลักษณะ เช่น ระบุคำและชื่อเฉพาะของมัน ก็แค่ใส่ทั้งสองอย่างไว้ด้วยกัน:",
    "e18": "เพื่อนของฉัน Tomaso อยู่ที่นั่น",
    "25": "แต่ถ้าคุณไม่สามารถหาคำที่เหมาะสมสำหรับบางสิ่งได้ล่ะ? งั้นคุณต้องใช้ประโยคแทน ลองคิดว่า ประโยคนั้นทำหน้าที่แทนชื่อ มันให้ข้อมูลเพียงพอที่จะสื่อสารแนวคิด แต่ใช้หลายคำ ลองดูตัวอย่างนี้:",
    "e19": "ฉันชอบความคิดที่ว่า แมวสามารถบินได้",
    "26": "\"la ideon\" (แนวคิด) อย่างเดียวยังไม่เพียงพอ เพราะมันไม่ได้บอกว่าแนวคิดนั้นคืออะไร ดังนั้นเราจึงเพิ่มประโยคที่อธิบายว่าแนวคิดคืออะไร คำสั่ง ๆ อย่าง <em>ke</em> มีหน้าที่เพียงแค่บอกว่า \"นี่เป็นอีกประโยคหนึ่ง\" มีกรณีที่สามารถทำแบบนี้ได้ มาลองดูอีกสักตัวอย่าง:",
    ...
    "28": "แต่จำไว้! ยิ่งคุณตัดคำออกไปมากเท่าไหร่ ความเสี่ยงที่ทุกอย่างจะดูไม่เข้าจะก็เพิ่มขึ้นเท่านั้น!",
    "29": "ในเมื่อเรากำลังพูดถึงเรื่องการตัดคำออกไป ก็มีอีกประเภทหนึ่งของคำกริยาที่ไม่ใช่กริยาโดยตรง หากลงท้ายด้วย <em>-i</em> มันเป็นลักษณะทั่วไปของคำกริยา เหตุการณ์นั้นไม่ได้ดำเนินอยู่ มันเพียงแค่มีอยู่ในลักษณะใดลักษณะหนึ่งและบ่งบอกว่ามีประโยคสมบูรณ์อยู่แต่ไม่ได้ถูกกล่าวถึง แต่ลองคิดดูว่ามันอาจถูกเข้าใจผิดได้หรือไม่***",
    "e22": "แมวต้องการนอน",
    "30": "ในที่สุด มีบางเรื่องที่ยังไม่อยากอธิบายในตอนนี้ พวกมันอาจจะทำให้สับสน และมักจะเกี่ยวข้องกับรากศัพท์ที่มีประโยชน์มาก ๆ อย่าง <em>ig</em> และ <em>iĝ</em>",
    ...
    "end": "แล้วตอนนี้เป็นอย่างไรบ้าง? เรียนรู้, นำไปใช้, และสนุกไปด้วยกัน! มีคอร์สออนไลน์ที่ <a href=\"https://lernu.net\">lernu.net</a>, kaj ĉe <a href=\"https://www.duolingo.com/\">Duolingo</a>, aŭ ĉe <a href=\"https://esperanto12.net/\">Esperanto en 12 lecionoj</a>. หรือจะดียิ่งกว่านั้น สมัครเรียนกับ <a href=\"https://londonaesperantoklubo.com/OnlineEsperantoCourses.html\"> ชมรมภาษาเอสเปรันโตลอนดอน (Londona Esperanto-Klubo)</a>."
  },
  // "se": {
